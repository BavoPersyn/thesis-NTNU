...
Figure \autoref{fig:scheme} shows an overview of the different steps the sequencer goes through. The original images are loaded one by one in a FIFO buffer. Each step, frame N and N-1 are sent to be processed. This process calculates the Homography \underline{${H}$}. 
