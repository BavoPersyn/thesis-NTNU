...
\section{Keypoint detection}\label{sec:keydet}
...
Now that keypoints are detected and point-to-point correspondences can be made we need to find the transformation from the first set of keypoints to the second. As stated before in \autoref{sec:determmot}, there are two cases. First we will handle the general case.\bigskip
