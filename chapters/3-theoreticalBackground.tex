...
\end{equation*}
\begin{equation*}
    \boldsymbol{T} = k\biggl(-\beta\boldsymbol{u_1} + (\frac{\lambda_3}{\lambda_2}-s\alpha)\boldsymbol{u_3}\biggr)
\end{equation*}
\begin{equation*}
    \begin{pmatrix}
        a & b & c
...
\end{equation*}
\begin{equation*}
    s = det(\boldsymbol{U}) det(\boldsymbol{V})
\end{equation*}
...
\begin{equation*}
    \boldsymbol{R} = \frac{1}{\lambda_1}\boldsymbol{A}-\biggl(\frac{\lambda_3}{\lambda_1}-s\biggr)\boldsymbol{u_3}\boldsymbol{v_3^T}
\end{equation*}
\begin{equation*}
    \boldsymbol{T} = k\biggl(\frac{\lambda_3}{\lambda_1}-s\biggr)
\end{equation*}
\begin{equation*}
    \begin{pmatrix}
        a & b & c
...
\begin{equation*}
    \boldsymbol{R} = (\frac{1}{\lambda_1})\boldsymbol{A}
\end{equation*}
In this case, it is not possible to determine translation vector $\boldsymbol{T}$ and the normal vector $(a, b, c)^T$ as there is not translation.
